    ...
    <footer className="relative overflow-hidden" style={{ background: "var(--hero-gradient)" }}>
      ...
      <div className="container relative py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Contact & Connect */}
          <div>
            <h4 className="font-body font-semibold text-xs uppercase tracking-[0.15em] text-primary-foreground/40 mb-5">Contact & Connect</h4>
            ...
            <div className="flex gap-4 mt-5">
              {[
                ...
                <a key={s.label} href={s.url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs text-primary-foreground/50 hover:text-primary-foreground/80 transition-colors font-body">
                  {s.label}
